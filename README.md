...
- **Rust** `>= 1.75.0` (last tested: `1.83.0`) - *You can install Rust here: [Rustup](https://rustup.rs/).*
...
- **Node.js** `>= 18` (last tested: `22`) and **npm** - *You can install Node.js and npm here: [Node.js](https://nodejs.org/en/download/package-manager).*
